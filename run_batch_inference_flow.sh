...
# 默认参数
DATA_ROOT="/home/unitree/remote_jensen/huangjianxin/open-x/train/images/bridge"
OUTPUT_ROOT="/home/unitree/remote_jensen/huangjianxin/open-x/train/flows/bridge"
# OUTPUT_ROOT="./mask"
MODEL="base"
DEVICE="cuda:2"
NO_VIS=true
...
while [[ $# -gt 0 ]]; do
    case $1 in
        ...
        -h|--help)
            ...
            echo ""
            echo "必需参数:"
            echo "  -d, --data_root PATH        数据根目录路径（包含image_X目录的路径）"
...
PYTHON_SCRIPT="$SCRIPT_DIR/batch_inference_flow.py"
